...
import type fetchInbox from './fetchInbox';
import type listUsers from './listUsers';
import type removeMessage from './removeMessage';
...
export type ConvexAPI = {
  queries: {
    fetchInbox: ClientQuery<typeof fetchInbox>;
    listUsers: ClientQuery<typeof listUsers>;
  };
  mutations: {
    addUser: ClientMutation<typeof addUser>;
    removeMessage: ClientMutation<typeof removeMessage>;
    sendImage: ClientMutation<typeof sendImage>;
  };
};
